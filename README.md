...
Este Jupyter Book reúne el material académico del curso **Matemáticas Aplicadas III** de la **Universidad Icesi**. Su propósito es ofrecer a los estudiantes un recurso organizado, interactivo y reproducible para el estudio de los conceptos, métodos y aplicaciones abordados durante el curso.
...
## Acceso y uso de los cuadernos

Para activar la ejecución de código, haga clic en el botón circular con el ícono de encendido/apagado **⏻**, ubicado en la esquina superior derecha del panel central. Cuando aparezca la opción **Start**, selecciónela y espere a que se inicie el entorno de Python. Después, ejecute cada celda haciendo clic en su botón de reproducción **▶ (Play)**. El libro publicado es de solo lectura: los cambios realizados en la web son temporales y no se guardan permanentemente.

Para conservar tu trabajo puedes descargar un archivo `.ipynb` individual desde la página correspondiente, o descargar el [repositorio completo](https://github.com/Icesi-MA/Matematicas-Aplicadas-III). Los archivos descargados pueden abrirse en Google Colab o en JupyterLab.
